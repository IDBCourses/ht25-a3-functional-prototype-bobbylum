...
This is a small game in which you, Capybara, are faced with these colorful walls. You'll have to show off your moves to make it through these funky obstacles!


## Game description:

This game works with the keyboard to slide and change the moves you are doing to pass through the colorful walls on your path. You get three lives, which you can lose by bumping into the wall - which happens when you haven't done the right move in time. Your score will increase as you pass through the walls. 
